...
<head>
    ...
    <script>
        function togglePaymentDetails() {
            ...
            document.getElementById('credit-card-details').style.display = (paymentMethod === 'credit_card') ? 'block' : 'none';
        ...
        <section class="payment-form">
            ...
            <form method="POST">
                ...
                <div id="credit-card-details" style="display:none;">
                    ...
                    <input type="text" name="card_number" value="<?php echo htmlspecialchars($payment_details['card_number'] ?? ''); ?>">
                    <label>Expiration Month:</label>
                    <input type="text" name="exp_month" value="<?php echo htmlspecialchars($payment_details['exp_month'] ?? ''); ?>">
                    <label>Expiration Year:</label>
                    <input type="text" name="exp_year" value="<?php echo htmlspecialchars($payment_details['exp_year'] ?? ''); ?>">
                    <label>CVV:</label>
                    <input type="text" name="cvv" value="<?php echo htmlspecialchars($payment_details['cvv'] ?? ''); ?>">
                </div>
                <div id="bank-transfer-details" style="display:none;">
                    <label>Account Number:</label>
                    <input type="text" name="account_number" value="<?php echo htmlspecialchars($payment_details['account_number'] ?? ''); ?>">
                    <label>Bank Name:</label>
                    <input type="text" name="bank_name" value="<?php echo htmlspecialchars($payment_details['bank_name'] ?? ''); ?>">
                    <label>IFSC Code:</label>
                    <input type="text" name="ifsc_code" value="<?php echo htmlspecialchars($payment_details['ifsc_code'] ?? ''); ?>">
                </div>
