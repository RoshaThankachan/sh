...
if ($order_id > 0) {
    ...
    SELECT b.booking_id, b.delivery_date, b.delivery_time, b.number_of_shoes, 
           ...
           c.cust_fname, c.cust_lname, c.house_name, c.street_name, 
    c.district, c.pincode, c.phone AS cust_phone, c.gender, 
...
<body>
    ...
    <?php echo htmlspecialchars($order_details['house_name']) . ', ' . 
               htmlspecialchars($order_details['street_name']) . ', ' . 
               htmlspecialchars($order_details['district']) . ', ' . 
               htmlspecialchars($order_details['pincode']); ?>
</p>

    <p><strong>Phone:</strong> <?php echo htmlspecialchars($order_details['cust_phone']); ?></p>
    <p><strong>Gender:</strong> <?php echo htmlspecialchars($order_details['gender']); ?></p>
